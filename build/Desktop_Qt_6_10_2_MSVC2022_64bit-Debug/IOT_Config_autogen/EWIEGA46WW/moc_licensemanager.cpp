...
void LicenseManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LicenseManager::*)(const QString & )>(_a, &LicenseManager::errorOccurred, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LicenseManager::*)(const QString & )>(_a, &LicenseManager::licenseUsed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (LicenseManager::*)(int )>(_a, &LicenseManager::executionNumberChanged, 2))
            return;
    }
}
